    ...
    async def skin(self, ctx, currency: str, *skin: str):
        ...
        try:
            ...
            if r.json()['success'] == True:
                ...
                await ctx.send("There was an error processing your request, ensure you're formatting it correctly.")
        except ValueError:
            await ctx.send('Failed, ensure that the currency and skin are both valid. Check the help for more info.')
